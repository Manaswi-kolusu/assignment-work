...
console.log("1. Marks >= 40 (Pass):", result1);

//  2: map() to add 5 grace marks to each student
let result2 = marks.map(mark => mark + 5);
console.log("2. Marks with 5 grace marks:", result2);

//  3: reduce() to find highest mark
let result3 = marks.reduce((max, mark) => mark > max ? mark : max);
console.log("3. Highest mark:", result3);

//  4: find() first mark below 40
let result4 = marks.find(mark => mark < 40);
console.log("4. First mark below 40:", result4);

//  5: findIndex() of mark 92
let result5 = marks.findIndex(mark => mark === 92);
console.log("5. Index of mark 92:", result5);